...
<div class="form-group col-sm-12">
    ...
    <fieldset>
        <?php
            ...
            echo $this->Form->control('time', ['second' => [],'label' => ['class' => 'col-sm-2 control-label']]);
            ...
            echo $this->Form->control('user_id', ['default'=>$result['user_id'],'options' => $users,'label' => ['class' => 'col-sm-2 control-label']]);
        ?>
    </fieldset>
